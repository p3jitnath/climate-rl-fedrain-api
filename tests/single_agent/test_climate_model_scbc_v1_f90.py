...
from examples.climate_models.f90.scbc_v1 import SCBC, SimpleClimateBiasCorrectionEnv
...
def test_scbc_episodic_return_matches_expected():
    """Run the SCBC v1 F90 environment loop and assert the final episodic return.
    ...
    envs = gym.vector.SyncVectorEnv(
        [
            make_env(
                functools.partial(SimpleClimateBiasCorrectionEnv, cid=0),
                SEED,
                NUM_STEPS,
            )
        ]
